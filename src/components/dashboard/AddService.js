                    ...
                    <>
                        <form className='p-4 p-sm-4 shadow p-3 mb-5 bg-white rounded signup-form' onSubmit={formik.handleSubmit}>
                            ...
                            <div className="mb-3">
                                ...
                                <select
                                    id='inputServiceType'
                                    className={`form-select ${formik.touched.service_type && formik.errors.service_type && 'is-invalid'}`}
                                    name='service_type'
                            ...
                            <div className="mb-3">
                                ...
                                <select
                                    id='inputSalon'
                                    className={`form-select ${formik.touched.salonID && formik.errors.salonID && 'is-invalid'}`}
                                    name='salonID'
